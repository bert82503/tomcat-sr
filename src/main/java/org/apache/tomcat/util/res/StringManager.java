...
/**
 * "'国际化/本地化'格式化文本提示信息管理器"帮助类。它不但减少"资源绑定(ResourceBundle)s"的
 * 处理，还只需关心公共的格式化文本提示信息而不需要创建对象数组。
 * <p>
 * 每个包(package)需要创建一个StringManager，并通过 {@link #getManager} 方法调用访问。
 * <p>
 * 要了解有关 java.util.ResourceBundle 的更多信息，请浏览其文档。
 * 
 * <p>
...
public class StringManager {
	...
	/**
	 * The ResourceBundle for this StringManager. ("资源绑定"处理器)
	 */
